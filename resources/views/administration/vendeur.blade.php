...
<head>
    ...
    <link rel="stylesheet" href="{{asset('acceuillogin/styles/shop_styles.css')}}">
    <link rel="stylesheet" href="{{asset('acceuillogin/plugins/jquery-ui-1.12.1.custom/jquery-ui.css')}}">
    <link rel="stylesheet" href="{{asset('acceuillogin/styles/shop_responsive.css')}}">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="shop_content">
                        <div class="shop_bar clearfix">
                            <div class="shop_product_count"><span> <?php $nombre = count($vendeur) ?>
                                    {!! $nombre !!} </span> produits trouvés
                            </div>
                            <div class="shop_sorting">
                                <span>Trier Par:</span>
                                <ul>
                                    <li>
                                        <span class="sorting_text">Les meilleurs ratio<i
                                                    class="fas fa-chevron-down"></span></i>
                                        <ul>
                                            <li class="shop_sorting_button"
                                                data-isotope-option='{ "sortBy": "original-order" }'>Les meilleurs ratio
                                            </li>
