...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::to('acceuillogin/styles/bootstrap4/bootstrap.min.css')}}">
    ...
    <link rel="stylesheet" href="{{ URL::to('acceuillogin/styles/main_styles.css')}}">
    <link rel="stylesheet" href="{{ URL::to('acceuillogin/styles/responsive.css')}}">
