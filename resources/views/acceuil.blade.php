...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('acceuillogin/styles/bootstrap4/bootstrap.min.css')}}">
    ...
    <link rel="stylesheet" href="{{ URL::asset('acceuillogin/styles/main_styles.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('acceuillogin/styles/responsive.css')}}">
